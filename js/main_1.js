  ...
  var e,
    t = {
      963: function (e, t, a) {
        ...
        const i = (e) => {
            window.postMessage(
              { call: "showcaseCTAPreviewDispatch", value: e },
              "*"
            );
          },
          d = [
          ...
          if (c.data.siteTypography) {
            const e = d.find(
              (e) =>
                ...
                c.data.siteTypography["headings-font-family"]
            );
            f = e && e.id;
          }
        ...
        var y = () => {
          const [{ selectedColorPallete: e }, t] = p(),
            [a, n] = (0, o.useState)([]),
            r = (e) => {
              t({
                type: "set",
          ...
          (0, o.useEffect)(() => {
            const e = ((e) => {
              ...
              if (e) {
                const a =
                  e["astra-settings"]["global-color-palette"].palette || [];
                a &&
                  (t = [
                    {
                      slug: "default",
          ...
          return (0, s.createElement)(
            ...
            (0, s.createElement)(
              ...
              (0, s.createElement)(
                ...
                (0, l.__)("Try Other Colors", "astra-sites-server")
              ),
              (0, s.createElement)(
                "div",
                {
                  className:
                    ...
                    ("" === e || "default" === e
                      ? "reset-btn opacity-40 cursor-not-allowed"
                      : "reset-btn active cursor-pointer"),
                  onClick: () => {
                    t({
                      type: "set",
                      ...
                      i({ param: "colorPalette", data: "" });
                  },
                },
                (0, l.__)("Default", "astra-sites-server")
              )
            ),
            (0, s.createElement)(
              "div",
              ...
              a.map((t, a) => {
                ...
                return (0, s.createElement)(
                  ...
                  (0, s.createElement)(
                    ...
                    {
                      className:
                        "flex flex-row text-[12px] font-medium text-gray-800",
                    },
                    t.title
                  ),
                  (0, s.createElement)(
            ...
            (0, s.createElement)(
              ...
              {
                className:
                  "grid grid-cols-2 pt-[20px] pb-[30px] gap-[10px] border-b border-solid border-gray-300",
              },
              d.map((t, a) => {
                const o = t.colors[0] || "",
                  n = t.colors[1] || "",
        ...
        const b = {
          ...
          questionMark: (0, s.createElement)(
            "svg",
            {
              width: "18",
              height: "18",
        ...
        var v = () => {
            const [{ sidebarOpen: e }, t] = p(),
              a = {
                customize: {
                  title: "Customize",
                  icon: b.customize,
                  onclick: () => {
                    t({ type: "set", sidebarOpen: !e });
                  },
                },
              };
            return (0, s.createElement)(
              ...
              {
                className:
                  "flex flex-col shadow-customize-btn rounded-tl-sm rounded-bl-sm",
              },
              Object.keys(a).map((t, o) => {
                const { title: n, icon: r, onclick: l, className: i } = a[t];
                return (0, s.createElement)(
                  "div",
                  {
                    key: o,
                    className: `${
                      i || ""
                    } st-customize-btn-item relative flex align-center items-center rounded-tl-sm rounded-bl-sm bg-white p-4 border-none ${
                      e ? "text-white" : "text-gray-800"
                    } cursor-pointer`,
                    onClick: l,
                  },
                  (0, s.createElement)(
                    ...
                    (0, s.createElement)(
                      ...
                      {
                        className:
                          "text-[15px] normal-case leading-4 font-medium tracking-normal pointer-events-none font-DM-sans",
                      },
                      n
                    )
                  )
            ...
            return (0, s.createElement)(
              ...
              a
                ? (0, s.createElement)(
                    ...
                    {
                      className:
                        "text-[#ffffff] opacity-0 invisible group-hover:opacity-100 group-hover:visible stc-tooltip-content py-1.5 px-3 absolute right-0 top-[110%] z-100 bg-gray-800 font-normal leading-none text-center min-w-max rounded-sm text-xs shadow-typoTooltip ",
                    },
                    a
                  )
                : null
        ...
        var E = () => {
            const [e] = (0, o.useState)(d),
              [t, a] = (0, o.useState)([]),
              [{ selectedTypographyIndex: n }, r] = p(),
              c = ((e) => {
                const t = {},
                  a = ["h1", "h2", "h3", "h4", "h5", "h6"];
                if (e) {
                  ...
                  a.forEach((e) => {
                    (t["font-family-" + e] = s[`font-family-${e}`]),
                      (t["font-weight-" + e] = s[`font-weight-${e}`]),
                      (t["text-transform-" + e] = s[`text-transform-${e}`]),
                      (t["line-height-" + e] = s[`line-height-${e}`]);
                  });
                }
                return t;
              })(showcaseCTA.customizerData),
            ...
            (0, o.useEffect)(() => {
              ...
              if (
                ((s.default = o),
                a(s),
                !document.getElementById("google-fonts-domain"))
              ) {
              ...
              if (e) {
                for (const t of e)
                  m += `&family=${w(t["headings-font-family"]).replaceAll(
                    " ",
                    "+"
                  )}:wght@${t["headings-font-weight"]}&family=${w(
                    t["body-font-family"]
                  ).replaceAll(" ", "+")}:wght@${t["body-font-weight"]}`;
                m = m.replace(/[&]{1}$/i, "");
              }
              if (r) {
                const e = `https://fonts.googleapis.com/css2?${r.join(
                  "&"
                )}${m}&display=swap`;
            ...
            const f = () => {
              r({ type: "set", selectedTypographyIndex: "", typography: {} }),
                i({ param: "siteTypography", data: "" });
            };
            return (0, s.createElement)(
              "div",
              { className: "flex flex-col" },
              (0, s.createElement)(
                ...
                {
                  className:
                    "flex align-center justify-between items-center mt-6",
                },
                (0, s.createElement)(
                  "p",
                  { className: "text-[16px] font-medium text-gray-800 m-0" },
                  (0, l.__)("Try Other Fonts", "astra-sites-server")
                ),
                (0, s.createElement)(
                  "div",
                  {
                ...
                (0, s.createElement)(
                  ...
                  Object.keys(t).map((e) => {
                    ...
                    return (0, s.createElement)(
                      "li",
                      {
                        className: `border-solid border rounded-sm border-gray-300 bg-[#F7F7F9] p-[8px] h-full text-[16px] hover:border-blue-600 hover:cursor-pointer hover:text-blue-600 text-gray-800 ${
                          "" === n ? "border-blue-600 text-blue-600" : ""
                      ...
                      (0, s.createElement)(
                        ...
                        (0, s.createElement)(
                          "span",
                          {
                            style: { fontFamily: o, fontWeight: l },
                        ...
                        (0, s.createElement)(
                          "span",
                          {
                            style: { fontFamily: a, fontWeight: r },
              ...
              (0, s.createElement)(
                ...
                (0, s.createElement)(
                  ...
                  {
                    className:
                      "grid grid-cols-4 gap-4 text-center list-none m-0 p-0",
                  },
                  Object.keys(d).map((e) => {
                    ...
                    return (0, s.createElement)(
                      ...
                      (0, s.createElement)(
                        "li",
                        {
                          className: `border-solid border rounded-sm border-gray-300 bg-[#F7F7F9] p-[8px] h-full text-[24px] hover:border-blue-600 hover:cursor-pointer hover:text-blue-600 text-gray-800 ${
                            n === e ? "border-blue-600 text-blue-600" : ""
                        ...
                        (0, s.createElement)(
                          ...
                          (0, s.createElement)(
                            "span",
                            {
                              style: { fontFamily: a, fontWeight: c },
                              className: "heading-font-preview",
                            },
                          ...
                          (0, s.createElement)(
                            "span",
                            {
                              style: { fontFamily: t, fontWeight: o },
                              className: "body-font-preview",
                            },
                            (0, l.__)("a", "astra-sites-server")
                          )
          ...
          C = () => {
            const [{ sidebarOpen: e, firstTimeShown: t }, a] = p(),
              [n, r] = (0, o.useState)("translate-x-[101%]"),
              i = (0, o.useRef)();
            (0, o.useEffect)(
              () => (
            ...
            const d = (e) => {
              i.current &&
                ...
                a({ type: "set", sidebarOpen: !1 });
            };
            return (
              (0, o.useEffect)(() => {
                t ||
                  setTimeout(() => {
                    a({ type: "set", firstTimeShown: !0 }), r("translate-x-0");
                  }, 1e3),
                  t &&
                    (setTimeout(() => {
                      r("translate-x-[86px]");
                ...
                (0, s.createElement)(
                  ...
                  (0, s.createElement)(
                    ...
                    (0, s.createElement)(
                      "div",
                      {
                        className: `fixed inset-y-0 right-0 pl-[40px] flex w-screen max-w-[368px] transform transition ease-in-out duration-400 sm:duration-500 ${
                          e ? "translate-x-0" : "translate-x-[101%]"
                        } `,
                      },
                      (0, s.createElement)(
                        "div",
                        {
                          className: `absolute top-1/3 ${
                            e ? "left-[-90px]" : "left-[-135px]"
                          } z-1 bg-white rounded-tl-sm rounded-bl-sm hover:rounded-tl-sm hover:rounded-bl-sm transform transition linear duration-400 sm:duration-500 ${n}`,
                        },
                        (0, s.createElement)(v, null)
                      ),
                      (0, s.createElement)(
                        "div",
                        {
                          className:
                            "h-full flex flex-col bg-white overflow-y-auto shadow-sidebar",
                        },
                        (0, s.createElement)(
                          "div",
                          {
                            className:
                              "py-[20px] px-[25px] shadow-templateName flex items-center justify-between z-[3] leading-none",
                          },
                          (0, s.createElement)(
                            "div",
                            { className: "flex" },
                            (0, s.createElement)(
                              ...
                              {
                                className:
                                  "text-[18px] font-semibold text-gray-600 m-0",
                                id: "slide-over-title",
                              },
                              showcaseCTA.templateName
                            )
                          ),
                          (0, s.createElement)(
                            "div",
                            {
                              className:
                                "close-sidebar-btn cursor-pointer border-solid border rounded-sm border-gray-300 p-[6px] hover:border-gray-800",
                              onClick: () => {
                                a({ type: "set", sidebarOpen: !1 });
                              },
                            },
                        ...
                        (0, s.createElement)(
                          ...
                          {
                            className:
                              "flex justify-between flex-col h-full z-[2] bg-white",
                          },
                          (0, s.createElement)(
                            "div",
                            ...
                            (0, s.createElement)(
                              ...
                              {
                                className:
                                  "text-[14px] text-gray-800 mb-[14px]",
                              },
                              (0, l.__)(
                            ...
                            ["gutenberg", "elementor"].includes(
                              showcaseCTA.pageBuilder[0]
                            ) && (0, s.createElement)(y, null),
                            (0, s.createElement)(E, null)
                          ),
                          "template" ===
                            ("customize",
                            ...
                            (0, s.createElement)(
                              ...
                              {
                                className:
                                  "px-5 py-3 shadow-show-templates-btn",
                              },
                              (0, s.createElement)(
                                "div",
                                {
                                  className:
                                    "flex place-content-center place-items-center bg-blue-600 hover:bg-blue-700 cursor-pointer text-white font-medium px-9 py-2.5 rounded text-[15px] mb-2.5 hover:transition-all hover:duration-100 hover:ease-linear",
                                },
                                (0, l.__)("Buy Now", "astra-sites-server")
                              ),
                              (0, s.createElement)(
                                "div",
                                {
                                  className:
                                    "flex place-content-center place-items-center bg-white cursor-pointer text-blue-600 hover:text-white hover:bg-blue-600 font-medium px-5 py-[0.525rem] rounded text-[13px] hover:transition-all hover:duration-100 hover:ease-linear border border-blue-600",
        ...
        r().render(
          (0, s.createElement)(
            (e) => {
              let { reducer: t, initialState: a, children: n } = e;
              return (0, s.createElement)(
                F.Provider,
              ...
              () => (
                (0, o.useEffect)(() => {
                  if (showcaseCTA.isMainSite) {
                    document
                      .querySelector("body")
                      .classList.remove("showcase-cta-preview-palette");
                    const e = document.getElementsByClassName(
                      "showcase-cta-preview-palette"
                    );
                    e.length > 0 && e[0].remove();
                    const t = document.getElementById(
                      "showcase-cta-typography"
                    );
                    t && t.remove(),
                      localStorage.removeItem("showcase-cta-preview-data");
                  }
                }, []),
                showcaseCTA.isMainSite ? null : (0, s.createElement)(C, null)
              ),
              null
            )
          ),
          document.getElementById("showcase-cta-entry-root")
        );
      },
    },
    a = {};
